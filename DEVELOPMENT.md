...
is 78 and the required capability set includes `COMMAND_SAVE_LAYER_COLOR_FILTER_REF`,
allowing Skiko/CMP command streams to apply typed color-filter descriptor handles
to saveLayer paints without passing raw Skia pointers across the runtime boundary.
