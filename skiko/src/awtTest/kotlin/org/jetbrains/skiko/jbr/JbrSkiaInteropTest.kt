...
class JbrSkiaInteropTest {
    ...
    fun rejectsEachMissingHighCommandCapability() {
        val capabilities = listOf(
            ...
            "fill rect save layer clip rect and save save layer save translate" to
                COMMAND_CAP64_HIGH_FILL_RECT_SAVE_LAYER_CLIP_RECT_SAVE_SAVE_LAYER_SAVE_TRANSLATE,
            "save translate and rotate" to COMMAND_CAP64_HIGH_SAVE_TRANSLATE_ROTATE,
            "save translate rotate translate fill oval restore" to
                COMMAND_CAP64_HIGH_SAVE_TRANSLATE_ROTATE_TRANSLATE_FILL_OVAL_RESTORE,
            "stroke closed polyline" to COMMAND_CAP64_HIGH_STROKE_CLOSED_POLYLINE,
            "stroke closed polyline delta" to COMMAND_CAP64_HIGH_STROKE_CLOSED_POLYLINE_DELTA,
            "stroke oval run" to COMMAND_CAP64_HIGH_STROKE_OVAL_RUN,
            "transformed fill oval run" to COMMAND_CAP64_HIGH_SAVE_TRANSLATE_ROTATE_TRANSLATE_FILL_OVAL_RESTORE_RUN,
            "transformed stroke closed polyline delta" to
                COMMAND_CAP64_HIGH_SAVE_TRANSLATE_ROTATE_TRANSLATE_STROKE_CLOSED_POLYLINE_DELTA_RESTORE,
            "fill rect run" to COMMAND_CAP64_HIGH_FILL_RECT_RUN,
            "clear full image ref and round rect" to COMMAND_CAP64_HIGH_CLEAR_DRAW_IMAGE_REF_FULL_DRAW_ROUND_RECT,
            "save layer and clip path" to COMMAND_CAP64_HIGH_SAVE_LAYER_CLIP_PATH,
        )
    ...
    private companion object {
        ...
        private const val REQUIRED_COMMAND_CAPABILITIES =
            -1L
        private const val REQUIRED_COMMAND_CAPABILITIES_HIGH = 855683921952636927L
