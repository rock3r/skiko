...
class JbrSkiaSwingLayer(
    ...
    private fun renderJbrCommandFrameOnce(g: Graphics2D, logFallbackOnFalse: Boolean): Boolean {
        ...
        return try {
            ...
            val commandStream = if (shouldApplyCommandCorruptionForTesting()) {
                ...
                .corruptStrokeRoundRectDashPathEffectStrokeWidthForTestingIfRequested()
                .corruptStrokeRoundRectDashPathEffectStrokeCapForTestingIfRequested()
                .corruptStrokeRoundRectDashPathEffectStrokeJoinForTestingIfRequested()
                .corruptStrokeRoundRectDashPathEffectStrokeMiterForTestingIfRequested()
                .corruptStrokeRoundRectDashPathEffectPhaseForTestingIfRequested()
                .corruptStrokeRoundRectDashPathEffectIntervalForTestingIfRequested()
                ...
                .corruptSaveLayerBlendModeWidthForTestingIfRequested()
                ...
                .corruptSaveLayerRecordLengthForTestingIfRequested()
                .corruptSaveLayerColorFilterRecordLengthForTestingIfRequested()
                .corruptSaveLayerBlendModeRecordLengthForTestingIfRequested()
                .corruptSaveLayerBlendColorFilterRecordLengthForTestingIfRequested()
                ...
                .corruptSaveLayerColorFilterRefRecordLengthForTestingIfRequested()
                .corruptSaveLayerBlendColorFilterRefRecordLengthForTestingIfRequested()
                .corruptSaveLayerImageFilterRefRecordLengthForTestingIfRequested()
    ...
    private companion object {
        ...
        const val CORRUPT_SAVE_LAYER_RECORD_LENGTH_PROPERTY =
            "skiko.jbr.interop.corruptSaveLayerRecordLengthForTesting"
        const val CORRUPT_SAVE_LAYER_COLOR_FILTER_RECORD_LENGTH_PROPERTY =
            "skiko.jbr.interop.corruptSaveLayerColorFilterRecordLengthForTesting"
        const val CORRUPT_SAVE_LAYER_BLEND_MODE_RECORD_LENGTH_PROPERTY =
            "skiko.jbr.interop.corruptSaveLayerBlendModeRecordLengthForTesting"
        const val CORRUPT_SAVE_LAYER_BLEND_COLOR_FILTER_RECORD_LENGTH_PROPERTY =
            "skiko.jbr.interop.corruptSaveLayerBlendColorFilterRecordLengthForTesting"
        ...
        const val CORRUPT_SAVE_LAYER_COLOR_FILTER_REF_RECORD_LENGTH_PROPERTY =
            "skiko.jbr.interop.corruptSaveLayerColorFilterRefRecordLengthForTesting"
        const val CORRUPT_SAVE_LAYER_BLEND_COLOR_FILTER_REF_RECORD_LENGTH_PROPERTY =
            "skiko.jbr.interop.corruptSaveLayerBlendColorFilterRefRecordLengthForTesting"
        const val CORRUPT_SAVE_LAYER_IMAGE_FILTER_REF_RECORD_LENGTH_PROPERTY =
            "skiko.jbr.interop.corruptSaveLayerImageFilterRefRecordLengthForTesting"
        ...
        const val CORRUPT_STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_WIDTH_PROPERTY =
            "skiko.jbr.interop.corruptStrokeRoundRectDashPathEffectStrokeWidthForTesting"
        const val CORRUPT_STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_CAP_PROPERTY =
            "skiko.jbr.interop.corruptStrokeRoundRectDashPathEffectStrokeCapForTesting"
        const val CORRUPT_STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_JOIN_PROPERTY =
            "skiko.jbr.interop.corruptStrokeRoundRectDashPathEffectStrokeJoinForTesting"
        const val CORRUPT_STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_MITER_PROPERTY =
            "skiko.jbr.interop.corruptStrokeRoundRectDashPathEffectStrokeMiterForTesting"
        const val CORRUPT_STROKE_ROUND_RECT_DASH_PATH_EFFECT_PHASE_PROPERTY =
            "skiko.jbr.interop.corruptStrokeRoundRectDashPathEffectPhaseForTesting"
        const val CORRUPT_STROKE_ROUND_RECT_DASH_PATH_EFFECT_INTERVAL_PROPERTY =
            "skiko.jbr.interop.corruptStrokeRoundRectDashPathEffectIntervalForTesting"
        ...
        private const val SAVE_LAYER_RECORD_LENGTH_CORRUPTED_MARKER =
            "SKIKO_JBR_INTEROP_SAVE_LAYER_RECORD_LENGTH_CORRUPTED"
        private const val SAVE_LAYER_COLOR_FILTER_RECORD_LENGTH_CORRUPTED_MARKER =
            "SKIKO_JBR_INTEROP_SAVE_LAYER_COLOR_FILTER_RECORD_LENGTH_CORRUPTED"
        private const val SAVE_LAYER_BLEND_MODE_RECORD_LENGTH_CORRUPTED_MARKER =
            "SKIKO_JBR_INTEROP_SAVE_LAYER_BLEND_MODE_RECORD_LENGTH_CORRUPTED"
        private const val SAVE_LAYER_BLEND_COLOR_FILTER_RECORD_LENGTH_CORRUPTED_MARKER =
            "SKIKO_JBR_INTEROP_SAVE_LAYER_BLEND_COLOR_FILTER_RECORD_LENGTH_CORRUPTED"
        ...
        private const val SAVE_LAYER_COLOR_FILTER_REF_RECORD_LENGTH_CORRUPTED_MARKER =
            "SKIKO_JBR_INTEROP_SAVE_LAYER_COLOR_FILTER_REF_RECORD_LENGTH_CORRUPTED"
        private const val SAVE_LAYER_BLEND_COLOR_FILTER_REF_RECORD_LENGTH_CORRUPTED_MARKER =
            "SKIKO_JBR_INTEROP_SAVE_LAYER_BLEND_COLOR_FILTER_REF_RECORD_LENGTH_CORRUPTED"
        private const val SAVE_LAYER_IMAGE_FILTER_REF_RECORD_LENGTH_CORRUPTED_MARKER =
            "SKIKO_JBR_INTEROP_SAVE_LAYER_IMAGE_FILTER_REF_RECORD_LENGTH_CORRUPTED"
        ...
        private const val STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_WIDTH_CORRUPTED_MARKER =
            "SKIKO_JBR_INTEROP_STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_WIDTH_CORRUPTED"
        private const val STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_CAP_CORRUPTED_MARKER =
            "SKIKO_JBR_INTEROP_STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_CAP_CORRUPTED"
        private const val STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_JOIN_CORRUPTED_MARKER =
            "SKIKO_JBR_INTEROP_STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_JOIN_CORRUPTED"
        private const val STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_MITER_CORRUPTED_MARKER =
            "SKIKO_JBR_INTEROP_STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_MITER_CORRUPTED"
        private const val STROKE_ROUND_RECT_DASH_PATH_EFFECT_PHASE_CORRUPTED_MARKER =
            "SKIKO_JBR_INTEROP_STROKE_ROUND_RECT_DASH_PATH_EFFECT_PHASE_CORRUPTED"
        private const val STROKE_ROUND_RECT_DASH_PATH_EFFECT_INTERVAL_CORRUPTED_MARKER =
            "SKIKO_JBR_INTEROP_STROKE_ROUND_RECT_DASH_PATH_EFFECT_INTERVAL_CORRUPTED"
        ...
        private val saveLayerBlendColorFilterRecordFlagsCorruptedForTesting =
            java.util.concurrent.atomic.AtomicBoolean(false)
        private val saveLayerRecordLengthCorruptedForTesting =
            java.util.concurrent.atomic.AtomicBoolean(false)
        private val saveLayerColorFilterRecordLengthCorruptedForTesting =
            java.util.concurrent.atomic.AtomicBoolean(false)
        private val saveLayerBlendModeRecordLengthCorruptedForTesting =
            java.util.concurrent.atomic.AtomicBoolean(false)
        private val saveLayerBlendColorFilterRecordLengthCorruptedForTesting =
            java.util.concurrent.atomic.AtomicBoolean(false)
        ...
        private val saveLayerImageFilterRefRecordFlagsCorruptedForTesting =
            java.util.concurrent.atomic.AtomicBoolean(false)
        private val saveLayerColorFilterRefRecordLengthCorruptedForTesting =
            java.util.concurrent.atomic.AtomicBoolean(false)
        private val saveLayerBlendColorFilterRefRecordLengthCorruptedForTesting =
            java.util.concurrent.atomic.AtomicBoolean(false)
        private val saveLayerImageFilterRefRecordLengthCorruptedForTesting =
            java.util.concurrent.atomic.AtomicBoolean(false)
        ...
        private val strokeRoundRectDashPathEffectRadiusYCorruptedForTesting =
            java.util.concurrent.atomic.AtomicBoolean(false)
        private val strokeRoundRectDashPathEffectStrokeWidthCorruptedForTesting =
            java.util.concurrent.atomic.AtomicBoolean(false)
        private val strokeRoundRectDashPathEffectStrokeCapCorruptedForTesting =
            java.util.concurrent.atomic.AtomicBoolean(false)
        private val strokeRoundRectDashPathEffectStrokeJoinCorruptedForTesting =
            java.util.concurrent.atomic.AtomicBoolean(false)
        private val strokeRoundRectDashPathEffectStrokeMiterCorruptedForTesting =
            java.util.concurrent.atomic.AtomicBoolean(false)
        private val strokeRoundRectDashPathEffectPhaseCorruptedForTesting =
            java.util.concurrent.atomic.AtomicBoolean(false)
        private val strokeRoundRectDashPathEffectIntervalCorruptedForTesting =
            java.util.concurrent.atomic.AtomicBoolean(false)
        ...
        private fun IntArray.corruptDrawVerticesIndexCountForTestingIfRequested(): IntArray {
            if (!java.lang.Boolean.getBoolean(CORRUPT_DRAW_VERTICES_INDEX_COUNT_PROPERTY)) return this
            return corruptFirstCommandArgumentForTesting(
                command = COMMAND_DRAW_VERTICES,
                argsOffset = 4,
                value = -1,
        ...
        private fun IntArray.corruptSaveLayerRecordLengthForTestingIfRequested(): IntArray {
            if (!java.lang.Boolean.getBoolean(CORRUPT_SAVE_LAYER_RECORD_LENGTH_PROPERTY)) return this
            return corruptFirstCommandRecordLengthForTesting(
                command = COMMAND_SAVE_LAYER,
                deltaBytes = -Int.SIZE_BYTES,
                marker = SAVE_LAYER_RECORD_LENGTH_CORRUPTED_MARKER,
                once = saveLayerRecordLengthCorruptedForTesting,
            )
        }

        private fun IntArray.corruptSaveLayerColorFilterRecordLengthForTestingIfRequested(): IntArray {
            if (!java.lang.Boolean.getBoolean(CORRUPT_SAVE_LAYER_COLOR_FILTER_RECORD_LENGTH_PROPERTY)) return this
            return corruptFirstCommandRecordLengthForTesting(
                command = COMMAND_SAVE_LAYER_COLOR_FILTER,
                deltaBytes = -Int.SIZE_BYTES,
                marker = SAVE_LAYER_COLOR_FILTER_RECORD_LENGTH_CORRUPTED_MARKER,
                once = saveLayerColorFilterRecordLengthCorruptedForTesting,
            )
        }

        private fun IntArray.corruptSaveLayerBlendModeRecordLengthForTestingIfRequested(): IntArray {
            if (!java.lang.Boolean.getBoolean(CORRUPT_SAVE_LAYER_BLEND_MODE_RECORD_LENGTH_PROPERTY)) return this
            return corruptFirstCommandRecordLengthForTesting(
                command = COMMAND_SAVE_LAYER_BLEND_MODE,
                deltaBytes = -Int.SIZE_BYTES,
                marker = SAVE_LAYER_BLEND_MODE_RECORD_LENGTH_CORRUPTED_MARKER,
                once = saveLayerBlendModeRecordLengthCorruptedForTesting,
            )
        }

        private fun IntArray.corruptSaveLayerBlendColorFilterRecordLengthForTestingIfRequested(): IntArray {
            if (!java.lang.Boolean.getBoolean(CORRUPT_SAVE_LAYER_BLEND_COLOR_FILTER_RECORD_LENGTH_PROPERTY)) return this
            return corruptFirstCommandRecordLengthForTesting(
                command = COMMAND_SAVE_LAYER_BLEND_COLOR_FILTER,
                deltaBytes = -Int.SIZE_BYTES,
                marker = SAVE_LAYER_BLEND_COLOR_FILTER_RECORD_LENGTH_CORRUPTED_MARKER,
                once = saveLayerBlendColorFilterRecordLengthCorruptedForTesting,
            )
        }
        ...
        private fun IntArray.corruptSaveLayerColorFilterRefRecordLengthForTestingIfRequested(): IntArray {
            if (!java.lang.Boolean.getBoolean(CORRUPT_SAVE_LAYER_COLOR_FILTER_REF_RECORD_LENGTH_PROPERTY)) return this
            return corruptFirstCommandRecordLengthForTesting(
                command = COMMAND_SAVE_LAYER_COLOR_FILTER_REF,
                deltaBytes = -Int.SIZE_BYTES,
                marker = SAVE_LAYER_COLOR_FILTER_REF_RECORD_LENGTH_CORRUPTED_MARKER,
                once = saveLayerColorFilterRefRecordLengthCorruptedForTesting,
            )
        }

        private fun IntArray.corruptSaveLayerBlendColorFilterRefRecordLengthForTestingIfRequested(): IntArray {
            if (!java.lang.Boolean.getBoolean(CORRUPT_SAVE_LAYER_BLEND_COLOR_FILTER_REF_RECORD_LENGTH_PROPERTY)) {
                return this
            }
            return corruptFirstCommandRecordLengthForTesting(
                command = COMMAND_SAVE_LAYER_BLEND_COLOR_FILTER_REF,
                deltaBytes = -Int.SIZE_BYTES,
                marker = SAVE_LAYER_BLEND_COLOR_FILTER_REF_RECORD_LENGTH_CORRUPTED_MARKER,
                once = saveLayerBlendColorFilterRefRecordLengthCorruptedForTesting,
            )
        }

        private fun IntArray.corruptSaveLayerImageFilterRefRecordLengthForTestingIfRequested(): IntArray {
            if (!java.lang.Boolean.getBoolean(CORRUPT_SAVE_LAYER_IMAGE_FILTER_REF_RECORD_LENGTH_PROPERTY)) return this
            return corruptFirstCommandRecordLengthForTesting(
                command = COMMAND_SAVE_LAYER_IMAGE_FILTER_REF,
                deltaBytes = -Int.SIZE_BYTES,
                marker = SAVE_LAYER_IMAGE_FILTER_REF_RECORD_LENGTH_CORRUPTED_MARKER,
                once = saveLayerImageFilterRefRecordLengthCorruptedForTesting,
            )
        }
        ...
        private fun IntArray.corruptStrokeRectDashPathEffectIntervalCountForTestingIfRequested(): IntArray =
            corruptDashPathEffectFieldForTestingIfRequested(
                property = CORRUPT_STROKE_RECT_DASH_PATH_EFFECT_INTERVAL_COUNT_PROPERTY,
                once = strokeRectDashPathEffectIntervalCountCorruptedForTesting,
        ...
        private fun IntArray.corruptStrokeRoundRectDashPathEffectIntervalCountForTestingIfRequested(): IntArray =
            corruptDashPathEffectFieldForTestingIfRequested(
                property = CORRUPT_STROKE_ROUND_RECT_DASH_PATH_EFFECT_INTERVAL_COUNT_PROPERTY,
                once = strokeRoundRectDashPathEffectIntervalCountCorruptedForTesting,
        ...
        private fun IntArray.corruptStrokeRoundRectDashPathEffectStrokeWidthForTestingIfRequested(): IntArray =
            corruptDashPathEffectFieldForTestingIfRequested(
                property = CORRUPT_STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_WIDTH_PROPERTY,
                once = strokeRoundRectDashPathEffectStrokeWidthCorruptedForTesting,
                command = COMMAND_STROKE_ROUND_RECT_DASH_PATH_EFFECT,
                argIndex = 7,
                value = 0,
                marker = STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_WIDTH_CORRUPTED_MARKER,
            )

        private fun IntArray.corruptStrokeRoundRectDashPathEffectStrokeCapForTestingIfRequested(): IntArray =
            corruptDashPathEffectFieldForTestingIfRequested(
                property = CORRUPT_STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_CAP_PROPERTY,
                once = strokeRoundRectDashPathEffectStrokeCapCorruptedForTesting,
                command = COMMAND_STROKE_ROUND_RECT_DASH_PATH_EFFECT,
                argIndex = 8,
                value = 3,
                marker = STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_CAP_CORRUPTED_MARKER,
            )

        private fun IntArray.corruptStrokeRoundRectDashPathEffectStrokeJoinForTestingIfRequested(): IntArray =
            corruptDashPathEffectFieldForTestingIfRequested(
                property = CORRUPT_STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_JOIN_PROPERTY,
                once = strokeRoundRectDashPathEffectStrokeJoinCorruptedForTesting,
                command = COMMAND_STROKE_ROUND_RECT_DASH_PATH_EFFECT,
                argIndex = 9,
                value = 3,
                marker = STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_JOIN_CORRUPTED_MARKER,
            )

        private fun IntArray.corruptStrokeRoundRectDashPathEffectStrokeMiterForTestingIfRequested(): IntArray =
            corruptDashPathEffectFieldForTestingIfRequested(
                property = CORRUPT_STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_MITER_PROPERTY,
                once = strokeRoundRectDashPathEffectStrokeMiterCorruptedForTesting,
                command = COMMAND_STROKE_ROUND_RECT_DASH_PATH_EFFECT,
                argIndex = 10,
                value = -1,
                marker = STROKE_ROUND_RECT_DASH_PATH_EFFECT_STROKE_MITER_CORRUPTED_MARKER,
            )

        private fun IntArray.corruptStrokeRoundRectDashPathEffectPhaseForTestingIfRequested(): IntArray =
            corruptDashPathEffectFieldForTestingIfRequested(
                property = CORRUPT_STROKE_ROUND_RECT_DASH_PATH_EFFECT_PHASE_PROPERTY,
                once = strokeRoundRectDashPathEffectPhaseCorruptedForTesting,
                command = COMMAND_STROKE_ROUND_RECT_DASH_PATH_EFFECT,
                argIndex = 11,
                value = -1,
                marker = STROKE_ROUND_RECT_DASH_PATH_EFFECT_PHASE_CORRUPTED_MARKER,
            )

        private fun IntArray.corruptStrokeRoundRectDashPathEffectIntervalForTestingIfRequested(): IntArray =
            corruptDashPathEffectFieldForTestingIfRequested(
                property = CORRUPT_STROKE_ROUND_RECT_DASH_PATH_EFFECT_INTERVAL_PROPERTY,
                once = strokeRoundRectDashPathEffectIntervalCorruptedForTesting,
                command = COMMAND_STROKE_ROUND_RECT_DASH_PATH_EFFECT,
                argIndex = 13,
                value = 0,
                marker = STROKE_ROUND_RECT_DASH_PATH_EFFECT_INTERVAL_CORRUPTED_MARKER,
            )
        ...
        private fun IntArray.corruptSaveLayerBlendModeWidthForTestingIfRequested(): IntArray {
            if (!java.lang.Boolean.getBoolean(CORRUPT_SAVE_LAYER_BLEND_MODE_WIDTH_PROPERTY)) return this
            return corruptFirstCommandArgumentForTesting(
                command = COMMAND_SAVE_LAYER_BLEND_MODE,
                argsOffset = 2,
                value = -1,
                marker = SAVE_LAYER_BLEND_MODE_WIDTH_CORRUPTED_MARKER,
                once = saveLayerBlendModeWidthCorruptedForTesting,
            )
        }

        private fun IntArray.corruptSaveLayerBlendModeHeightForTestingIfRequested(): IntArray {
            if (!java.lang.Boolean.getBoolean(CORRUPT_SAVE_LAYER_BLEND_MODE_HEIGHT_PROPERTY)) return this
            return corruptFirstCommandArgumentForTesting(
                command = COMMAND_SAVE_LAYER_BLEND_MODE,
                argsOffset = 3,
                value = -1,
                marker = SAVE_LAYER_BLEND_MODE_HEIGHT_CORRUPTED_MARKER,
                once = saveLayerBlendModeHeightCorruptedForTesting,
            )
        }

        private fun IntArray.corruptSaveLayerBlendColorFilterWidthForTestingIfRequested(): IntArray {
            if (!java.lang.Boolean.getBoolean(CORRUPT_SAVE_LAYER_BLEND_COLOR_FILTER_WIDTH_PROPERTY)) return this
            return corruptFirstCommandArgumentForTesting(
                command = COMMAND_SAVE_LAYER_BLEND_COLOR_FILTER,
                argsOffset = 2,
                value = -1,
                marker = SAVE_LAYER_BLEND_COLOR_FILTER_WIDTH_CORRUPTED_MARKER,
                once = saveLayerBlendColorFilterWidthCorruptedForTesting,
            )
        }

        private fun IntArray.corruptSaveLayerBlendColorFilterHeightForTestingIfRequested(): IntArray {
            if (!java.lang.Boolean.getBoolean(CORRUPT_SAVE_LAYER_BLEND_COLOR_FILTER_HEIGHT_PROPERTY)) return this
            return corruptFirstCommandArgumentForTesting(
                command = COMMAND_SAVE_LAYER_BLEND_COLOR_FILTER,
                argsOffset = 3,
                value = -1,
...
internal class EncodedCommandBufferCache(
    ...
    private companion object {
        ...
        private const val MAX_CONSECUTIVE_DEFERRALS_BEFORE_BYPASS = 2
        private const val BYPASS_PROBE_INTERVAL = 3840
    }
}
